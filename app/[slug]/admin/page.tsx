...
export default async function ProfileAdminPage({ params }: ProfileAdminPageProps) {
  ...
  if (!authorizedProfile) {
    return (
      <main className="profile-admin-page">
  ...
  return (
    <main className="profile-admin-page profile-admin-page-light">
      <div className="profile-admin-wrap">
        ...
        <section className="panel">
          <ProfileEditorForm action={updateOwnedProfileAction} mode="owner-edit" profile={profile} />
        </section>
      </div>
    </main>
  );
